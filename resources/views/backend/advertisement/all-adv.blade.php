...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12 title">
      <h1><i class="fa fa-bars"></i> All Advertisement <button class="btn btn-sm btn-default"><a href="{{url('add-adv')}}">Add New </a></button></h1>
    </div>
    <div class="col-sm-12">
        ...
        <table class="table table-striped" id="myTable">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>{{$d->url}}</td>
                <td>{{$d->location}}</td>
                <td><img src="{{url('public/advertisements')}}/{{$d->image}}" alt="" width="200"> </td>
                <td>{{$d->status}}</td>
              </tr>
            @endforeach
            @else
